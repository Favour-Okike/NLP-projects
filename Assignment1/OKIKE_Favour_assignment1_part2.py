 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    tokens = nltk.word_tokenize(moby_raw)\n",
    "    \n",
    "    whale_count = sum(1 for w in tokens if w == 'whale' or w == 'Whale')\n",
    "    \n",
    "    percentage = (whale_count / len(tokens)) * 100\n",
    "    \n",
    "    return percentage\n",
    "\n",
    "# Test your function\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    freq_dist = nltk.FreqDist(tokens)\n",
    "    \n",
    "    result = [token for token in freq_dist \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    \n",
    "    token_counts = [len(nltk.word_tokenize(sentence)) for sentence in sentences]\n",
    "    \n",
    "    average = sum(token_counts) / len(sentences)\n",
    "    \n",
    "    return average\n",
    "    \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    \n",
    "    stems = [stemmer.stem(w.lower()) for w in tokens if w.isalpha()]\n",
    "    \n",
