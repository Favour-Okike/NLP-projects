 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    \"\"\"\n",
    "    # YOUR CODE HERE\n",
    "    pattern =  r'\\b(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)[a-z]*\\.?[-\\s]\\d{1,2},?\\s\\d{4}\\b'  # Define your regex pattern\n",
    "    \n",
    "    results = []\n",
    "    for note in df:\n",
    "        matches = re.findall(pattern, note)\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    \"\"\"\n",
    "    # YOUR CODE HERE\n",
    "    regpattern = r'\\(?(\\d{3})\\)?[-.\\s](\\d{3})[-.\\s](\\d{4})'\n",
    "    connects = re.findall(regpattern, text)\n",
    "    numbers = [f\"{a}-{b}-{c}\" for a, b, c in connects]\n",
    "    return numbers  # Return list of standardized phone numbers\n",
    "\n",
    "# Test your function\n",
    "test_text = \"\"\"\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      "Result length: 500\n",
      "First 10 indices: [25, 481, 40, 39, 71, 470, 466, 99, 493, 9]\n",
      "Last 10 indices: [257, 152, 464, 253, 427, 231, 141, 186, 161, 413]\n"
     ]
    }
   ],
   "source": [
    ...
    "                year += 1900\n",
    "        \n",
    "        # 2. Month dd, yyyy / Month-dd-yyyy / Month dd yyyy / Month. dd, yyyy / Month ddth, yyyy\n",
    "        if year is None:\n",
    "            m = re.search(\n",
    "                r'\\b('\n",
    ...
    "                month = month_map[mon.lower().rstrip('.')]\n",
    "                day = int(day)\n",
    "                year = int(year)\n",
    "        \n",
    ...
    "        # 5. mm/yyyy\n",
    "        if year is None:\n",
    "            m = re.search(r'\\b(\\d{1,2})/(\\d{4})\\b', note)\n",
    "            if m:\n",
    "                month, year = m.groups()\n",
    "                month = int(month)\n",
    "                day = 1\n",
    ...
    "        # 6. yyyy\n",
    "        if year is None:\n",
    "            m = re.search(r'\\b(19\\d{2}|20\\d{2})\\b', note)\n",
    "            if m:\n",
    "                year = int(m.group(1))\n",
    "                month = 1\n",
    "                day = 1\n",
    ...
    "    \n",
    "    dates = pd.Series(parsed_dates, index=df.index)\n",
    "\n",
    "    \n",
    "    # Hint: \n",
    ...
    "    \n",
    "    return pd.Series(dates.sort_values().index)  # Return the sorted indices\n",
    "\n",
    "# Test your function\n",
